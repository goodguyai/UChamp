...
import { ArrowLeft, Search, SlidersHorizontal, Eye, Star, StarOff } from 'lucide-react';
      ...
      <header className="border-b border-gray-800 bg-black-card/80 backdrop-blur-md sticky top-0 z-40">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <span className="text-gray-400 text-sm font-medium uppercase tracking-wider">Recruiter Portal</span>
          </div>
          <div className="flex items-center gap-2 text-gray-400 text-sm">
            <Star size={16} className="text-gold-primary" />
            <span>{watchlist.size} on watchlist</span>
          </div>
        </div>
      </header>
