...
export default function ReliabilityHero({ athlete }: ReliabilityHeroProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-black-elevated via-black-card to-black-elevated p-8 border-2 border-gold-primary shadow-gold-glow">
      {/* Background pattern */}
      ...
      {/* Radial glow */}
      <div className="absolute -top-20 -right-20 w-60 h-60 bg-gold-primary/10 rounded-full blur-3xl" />
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-baseline gap-4 mb-6">
          <span className="font-mono text-7xl md:text-8xl font-black gold-shimmer">
            {reliabilityScore}
          </span>
          <span className="text-3xl text-gray-600 font-mono">/100</span>
        </div>

        {/* Status label */}
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gold-bright/20 border border-gold-bright mb-8">
          <Trophy className="text-gold-bright" size={20} />
          <span className="text-gold-bright font-bold uppercase text-sm tracking-wide">
            {label} STATUS
          </span>
        </div>
